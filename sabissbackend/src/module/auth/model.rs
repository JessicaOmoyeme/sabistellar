...
pub struct WalletRecord {
    ...
    pub factory_contract_id: Option<String>,
...
pub struct UserProfileRecord {
    ...
    pub wallet_factory_contract_id: Option<String>,
    pub wallet_web_auth_contract_id: Option<String>,
    pub wallet_web_auth_domain: Option<String>,
    pub wallet_owner_encrypted_private_key: Option<String>,
    pub wallet_owner_encryption_nonce: Option<String>,
    pub wallet_owner_key_version: Option<i32>,
...
impl UserProfileRecord {
    pub fn into_parts(self) -> (UserRecord, Option<WalletRecord>) {
        ...
        let wallet = match (
            ...
            (Some(wallet_address), Some(network), Some(account_kind), Some(wallet_status), Some(created_at)) => Some(WalletRecord {
                wallet_address: Some(wallet_address),
                network,
                account_kind,
                wallet_status,
                wallet_standard: self.wallet_standard,
                owner_address: self.wallet_owner_address,
                ...
                factory_contract_id: self.wallet_factory_contract_id,
                web_auth_contract_id: self.wallet_web_auth_contract_id,
                web_auth_domain: self.wallet_web_auth_domain,
                owner_encrypted_private_key: self.wallet_owner_encrypted_private_key,
                owner_encryption_nonce: self.wallet_owner_encryption_nonce,
                owner_key_version: self.wallet_owner_key_version,
